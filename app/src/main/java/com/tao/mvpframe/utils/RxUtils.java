...
//     * @param <T>
//     */
//    public static <T> void toSubscribe(Observable<T> observable, RxHtteResultObserver<T> resultObserver, Lifecycle lifecycle, boolean obserMain) {
//        try {
//            toSubscribe(observable, resultObserver, lifecycle, obserMain);
//        } catch (Exception e) {
//            e.printStackTrace();
//            resultObserver.onFault(e.getMessage());
//        }
//    }
